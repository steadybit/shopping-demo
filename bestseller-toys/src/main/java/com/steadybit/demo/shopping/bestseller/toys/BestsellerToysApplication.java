...
@SpringBootApplication public class BestsellerToysApplication implements CommandLineRunner {
    ...
    @Override public void run(String... args) {
        ...
        List<Object[]> products = Stream.of(
                        new Object[] { randomUUID(), "Steadybit Stickers", ProductCategory.TOYS.toString(), "sticker", new BigDecimal("0.99") },
                        new Object[] { randomUUID(), "Steadybit Keychain", ProductCategory.TOYS.toString(), "keychain", new BigDecimal("3.99") },
                        new Object[] { randomUUID(), "Steadybit Pillow", ProductCategory.TOYS.toString(), "pillow", new BigDecimal("8.99") })
